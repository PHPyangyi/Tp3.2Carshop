...
<div class="fixed"> <a href="book.php" title="留言" class="barbook"></a> <a href="javascript:;" title="二维码" class="codepic"></a> <a href="javascript:;" title="返回顶部" class="backup"></a>
  <div> <img src=" " alt="这里是您的网站名称" class="code" /> </div>
</div>
...
<div class="fy" style=" background:url(/Tp3.2carshop/Public/Home/images/4.jpg) center top no-repeat;">
    ...
    <div class="l_pro">
        ...
        <ul class="l_procon">
            ...
            <?php foreach($son2 as $k=>$v): $cateid=$v['id']; if($contro){ $url="/Tp3.2carshop/index.php/Home/Carlist/index/cateid/$cateid"; }else{ $url="/Tp3.2carshop/index.php/Home/Page/index/cateid/$cateid"; } ?>
    ...
    <div class="fyRight">
      <div class="title"> <span class="fl"><?php echo ($cates["name"]); ?></span>

          <span class="fr">当前位置：<a href="" title="首页">首页</a> > <font><?php echo ($cates["name"]); ?></font> </span></div>
