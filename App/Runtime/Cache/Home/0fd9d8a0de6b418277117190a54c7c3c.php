        ...
        <ul class="l_procon">
            ...
            <li class="proOne"><a title="<?php echo $v['name'];?>" href="<?php echo $url;?>"><?php echo $v['name'];?></a>
                ...
                <ul>
                    ...
                    <li><a style="margin-left:40px;"   href="/Tp3.2carshop/index.php/Home/Article/index/cateid/<?php echo $v1['id'];?>"   title="<?php echo $v1['name'];?>" ><?php echo $v1['name'];?></a></li>
        ...
        <div class="fyRight">
        		 <div class="aaleft" >
						<div class="aaleft_kk" id="fix">
									<a class="fy-left">上<br />一<br />页</a>						</div>
                   </div>  
                ...
                <div class="aaleft1" >
						...
						<div class="aaleft_kk" id="fix1">
									...
									<a class="fy-right" href="case_view.php?id=48" title="车型：车型展示名称">下<br />一<br />页</a>						</div>
                   </div>
      			<div class="title"> <span class="fl"> 主要车型</span> <span class="fr">当前位置：<a href="http://0001543.ks.panguweb.cn/" title="首页">首页</a> > <a href="case.php" title="主要车型">主要车型</a> > <font>一级分类名称-1</font> </span></div>
				<div class="padding25">
                    <h2 class="center">车型：车型展示名称</h2>
                    <p class="title_s">文章来源：admin&nbsp;&nbsp;&nbsp;&nbsp;时间：2015-08-10</p>
                                        <p class="center"><img src="/Tp3.2carshop/Public/Home/images/20150810100856-61052986513823272.jpg" alt="车型：车型展示名称" /></p>
                                        <p class="pro-ri">日租：123.00元/天</p>
                     <p class="pro_cname"><span>详细介绍</span></p>
                    <div class="newsview">
                     
                     <div class='pb'><div class='pagebox'>盘古网络，一流的百度产品推广服务运营商，致力于在互联网时代帮助中国企业进行营销方式的革命，并使他们在这场营销变革中抢占先机。<br />
　　<br />
　　盘古网络成立于2003年，现有员工2000多人，下设20多家子公司，业务覆盖河北、辽宁、吉林三省，提供域名注册、虚拟主机、企业邮局、网站建设、网络推广、呼叫中心、电子支付等全套网络营销解决方案。<br />
　　<br />
　　盘古网络从创立至今已经为数万家企业提供了专业的网络营销产品，并通过专业的网络营销服务使这些企业获得了良好的营销效果。<br />
　 　<br />
　　盘古网络聚集IT界的精英，由资深的网站设计师、软件开发工程师、营销顾问专家及专业客服实施顾问团队、技术服务团队等组成。几年来，盘古人本着"自强 不 息、厚德载物"的企业精神，坚持"诚信为本"的经营理念，以"追求客户的感动"为目标来指导市场动作行为，并逐步推出高质量的网络增值服务，为众多企业实 现网络营销梦想做出积极的努力。<br />
<br />
　　今日盘古，如朝阳初升。在中国国际实力日益壮大，经济全球化日益凸显的时代背景下，盘古也将扮演着更为重要的角色，承载着中国更多企业的商业梦想，背负着中国信息产业国际化的历史重任。<br />
　　<br />
　　盘古网络，百度最大的代理商；<br />
　　盘古网络，百度首家跨省经营的代理商；<br />
　　盘古网络，百度唯一一家拥有省级代理资质的代理商。<br />
　　精诚合作，共赴成功！<div align='center'></div></div></div></div>
