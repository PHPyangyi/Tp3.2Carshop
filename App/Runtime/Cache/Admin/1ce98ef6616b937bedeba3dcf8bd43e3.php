...
<link rel="stylesheet" type="text/css" href="/Tp3.2carshop/Public/Admin/css/admin_login.css"/>
...
<div class="topbar-wrap white">
    <div class="topbar-inner clearfix">
        ...
        <div class="top-info-wrap">
            <ul class="top-info-list clearfix">
                <li><a href="/Tp3.2carshop/index.php/Admin/Admin/updata/id/<?php echo session('id');?>">欢迎您 | <?php echo session('rolename');?>:<?php echo session('username');?></a></li>
                <li><a href="/Tp3.2carshop/index.php/Admin/Admin/updata/id/<?php echo session('id');?>">修改密码</a></li>
                <li><a href="#">退出</a></li>
            </ul>
        </div>
    </div>
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/jscss/admin/design/">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/Tp3.2carshop/index.php/Admin/Admin/lst">管理员管理</a><span class="crumb-step">&gt;</span><span>修改管理员</span></div>
        </div>
