...
<div class="fy" style=" background:url(/Tp3.2carshop/Public/Home/images/4.jpg) center top no-repeat;">
    ...
    <div class="l_pro">
        ...
        <ul class="l_procon">
            ...
            <?php foreach($son2 as $k=>$v): $cateid=$v['id']; if($contro){ $url="/Tp3.2carshop/index.php/Home/Carlist/index/cateid/$cateid"; }else{ $url="/Tp3.2carshop/index.php/Home/Zplist/index/cateid/$cateid"; } ?>
            ...
            <li class="proOne"><a title="<?php echo $v['name'];?>" href="<?php echo $url;?>"><?php echo $v['name'];?></a>
                ...
                <ul>
                    ...
                    <li><a style="margin-left:40px;"   href="/Tp3.2carshop/index.php/Home/Zplist/index/cateid/<?php echo $v1['id'];?>"   title="<?php echo $v1['name'];?>" ><?php echo $v1['name'];?></a></li>
  ...
  <div class="fyRight">
      <div class="title"> <span class="fl"> 人才招聘</span> <span class="fr">当前位置：<a href=" " title="首页">首页</a> > <font>人才招聘</font> </span></div>
                 ...
                 <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="hrBox">
                         ...
                         <div class="hrBoxR">
                             <ul>
                                 <li class="topline"><span class="fl"><?php echo ($vo["title"]); ?></span><a title="应聘此职位" class="fr" href="/Tp3.2carshop/index.php/Home/Job/index/arid/<?php echo ($vo["id"]); ?>"><img width="90" height="26" src="/Tp3.2carshop/Public/Home/images/re.gif"></a>
                                     <div class="clear"></div>
                                 </li>
