...
<div class="fy" style=" background:url(./images/4.jpg) center top no-repeat;">
    	<div class="fra">

            <div class="fyLeft">

    <div class="l_pro">
        <div class="l_pro_t"></div>
        <ul class="l_procon">




            <?php foreach($son2 as $k=>$v): $cateid=$v['id']; if($contro){ $url="Tp3.2carshop/index.php/Home/Carlist/index/cateid/$cateid"; }else{ $url="Tp3.2carshop/index.php/Home/Carlist/index/cateid/$cateid"; } ?>
    ...
    <div class="fl-contact">
        ...
        <div class="fyRight">
                ...
                <div class="aaleft1" >
      			...
      			<div class="title"> <span class="fl"><?php echo ($cate["name"]); ?></span> <span class="fr">当前位置：<a href="http://0001543.ks.panguweb.cn/" title="首页">首页</a> > <a href="case.php" title="主要车型">主要车型</a> > <font>一级分类名称-1</font> </span></div>
				<div class="padding25">
                    <h2 class="center"><?php echo ($data["title"]); ?></h2>
                    <p class="title_s">文章来源：<?php echo ($data["author"]); ?>&nbsp;&nbsp;&nbsp;&nbsp;时间：<?php echo (date("Y-m-d",$date["time"])); ?> </p>
                     <!--<div style="width: 200px;height: 200px;background: url('<?php echo ($data["pic"]); ?>')  ;margin: auto"></div>-->
                    <?php if($data["rizu"] != '0'): ?><p class="pro-ri">日租：<?php echo ($data["rizu"]); ?>元/天</p><?php endif; ?>

                     <p class="pro_cname"><span>详细介绍</span></p>
                    <div class="newsview">
                        <?php echo htmlspecialchars_decode($data['content']);?>
                    
                    <a href="javascript:history.go(-1) "      class="returnlist" title="返回列表">返回列表</a> </div>
