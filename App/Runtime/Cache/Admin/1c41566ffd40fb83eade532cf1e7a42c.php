...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/jscss/admin/design/">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/Tp3.2carshop/index.php/Admin/Privilege/lst">权限管理</a><span class="crumb-step">&gt;</span><span>新增权限</span></div>
        </div>
                        ...
                        <tbody><tr>
                            ...
                            <td>
                                <select name="parentid" id="catid" class="required">
                                    ...
                                    <?php if(is_array($pris)): $i = 0; $__LIST__ = $pris;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php if($vo['parentid'] != 0): ?>|<?php endif; echo str_repeat('-', $vo['level']*8); echo ($vo["pri_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                            </td>
                        </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title" name="mname" size="50" value="" type="text">
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title" name="aname" size="50" value="" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th></th>
