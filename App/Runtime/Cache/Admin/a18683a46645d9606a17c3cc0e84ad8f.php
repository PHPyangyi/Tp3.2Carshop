                ...
                <form name="myform" id="myform" method="post">
                    <div class="result-title">
                        <div class="result-list">
                            <a href="/Tp3.2carshop/index.php/Admin/Cate/add" class="btn btn-primary btn2"><i class="icon-font"></i>新增栏目</a>
                            <a id="batchDel" href="javascript:void(0)"><i class="icon-font"></i><input form="myform" formaction="/Tp3.2carshop/index.php/Admin/Cate/bdel" type="submit" class="btn btn-primary btn2" value="批量删除" /></a>
                            <a id="updateOrd" href="javascript:void(0)"><i class="icon-font"></i><input form="myform" formaction="/Tp3.2carshop/index.php/Admin/Cate/sortcate" type="submit" class="btn btn-primary btn2" value="更新排序" /></a>
                        </div>
                    </div>
                    <div class="result-content">
                        <table class="result-tab" width="100%">
                            ...
                            <?php if(is_array($cates)): $i = 0; $__LIST__ = $cates;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td>
                                        <?php if($vo['pic'] != ''): ?><img src="/Tp3.2carshop<?php echo ($vo["pic"]); ?>" height="50">
                                            <?php else: ?>
                                            暂无缩略图<?php endif; ?>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <a class="link-update" href="/Tp3.2carshop/index.php/Admin/Cate/update/id/<?php echo ($vo["id"]); ?>">修改</a>
                                        <a class="link-del" onclick="return confirm('确定删除本栏目及其子栏目？');" href="/Tp3.2carshop/index.php/Admin/Cate/del/id/<?php echo ($vo["id"]); ?>">删除</a>
                                    </td>
