...
<div class="fy" style=" background:url(./images/4.jpg) center top no-repeat;">
    ...
    <div class="l_pro">
        ...
        <ul class="l_procon">
            ...
            <?php foreach($son2 as $k=>$v): $cateid=$v['id']; if($contro){ $url="/Tp3.2carshop/index.php/Home/Carlist/index/cateid/$cateid"; }else{ $url="/Tp3.2carshop/index.php/Home/Rylist/index/cateid/$cateid"; } ?>
            ...
            <li class="proOne"><a title="<?php echo $v['name'];?>" href="<?php echo $url;?>"><?php echo $v['name'];?></a>
                ...
                <ul>
                    ...
                    <li><a style="margin-left:40px;"   href="/Tp3.2carshop/index.php/Home/Rylist/index/cateid/<?php echo $v1['id'];?>"   title="<?php echo $v1['name'];?>" ><?php echo $v1['name'];?></a></li>
		    ...
		    <ul class="case-ul">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                        <a href="/Tp3.2carshop/index.php/Home/Article/index/arid/<?php echo ($vo["id"]); ?>" title="<?php echo ($vo["title"]); ?>">
                            <img src="/Tp3.2carshop<?php echo ($vo["pic"]); ?>" width="245" height="184" alt="<?php echo ($vo["title"]); ?>" />
