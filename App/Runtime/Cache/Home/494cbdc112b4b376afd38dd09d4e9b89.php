...
<script type="text/javascript" src="/Tp3.2carshop/Public/Home/style/js/jquery.lightbox-0.5.min.js"></script>
<script type="text/javascript">
    $(function() {
        $('.zoombut').lightBox();
    });
...
<div class="fy" style=" background:url(/Tp3.2carshop/Public/Home/images/4.jpg) center top no-repeat;">
        ...
        <ul class="l_procon">
            ...
            <li class="proOne"><a title="<?php echo $v['name'];?>" href="<?php echo $url;?>"><?php echo $v['name'];?></a>
                ...
                <ul>
                    ...
                    <li><a style="margin-left:40px;"   href="/Tp3.2carshop/index.php/Home/Carlist/index/cateid/<?php echo $v1['id'];?>"   title="<?php echo $v1['name'];?>" ><?php echo $v1['name'];?></a></li>
    ...
    <div class="fl-contact">
        ...
        <div class="fyRight">
      			<div class="title"> <span class="fl"> 车辆展示</span> <span class="fr">当前位置：<a href=" " title="首页">首页</a> > <font>车辆展示</font> </span></div>
    		    <ul class="proul">

                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                         <a href="/Tp3.2carshop/index.php/Home/Article/index/arid/<?php echo ($vo["id"]); ?>" title="车型：<?php echo ($vo["title"]); ?>">
                             <p class="casetitle1" ><span title="车型：<?php echo ($vo["title"]); ?>" href="/Tp3.2carshop<?php echo ($vo["pic"]); ?>" class="zoombut"></span><span class="jianjie">车型：<?php echo ($vo["title"]); ?></span> </p>
                             <img src="/Tp3.2carshop<?php echo ($vo["pic"]); ?>" width="245" height="184" alt="车型：<?php echo ($vo["title"]); ?>" />
