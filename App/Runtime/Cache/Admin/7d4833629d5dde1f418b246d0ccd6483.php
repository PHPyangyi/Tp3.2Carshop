...
<div class="topbar-wrap white">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/jscss/admin/design/">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/Tp3.2carshop/index.php/Admin/cate/lst">文章管理</a><span class="crumb-step">&gt;</span><span>修改文章</span></div>
        </div>
                    ...
                    <table class="insert-tab" width="100%">
                        <tbody><tr>
                            ...
                            <tr>
                                ...
                                <?php if($artres['pic'] != ''): ?><img src="/Tp3.2carshop<?php echo ($artres["pic"]); ?>" height="50" /><?php else: ?>暂无缩略图<?php endif; ?>
                                </td>
                            </tr>
                            <tr>
                                <th>内容：</th>
